...
export class ShareSection extends React.Component<ShareSectionProps> {
  public render() {
    ...
    return (
      <div className={classnames("twist", "share-twist")}>
        ...
        <div className="share-actions">
          <a
            className={classnames("r2c-action-button", "email-button")}
            title="Email"
          ...
          <a
            className={classnames("r2c-action-button", "link-button")}
